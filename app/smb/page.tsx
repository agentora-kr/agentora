...
export default function SmbPage() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-orange-50 flex flex-col items-center justify-center px-6 py-20">
      <div className="max-w-lg w-full text-center">
        ...
        <div className="inline-block bg-orange-50 border border-orange-100 rounded-full px-4 py-1.5 mb-7">
          <span className="text-xs font-bold text-orange-500">🏪 소상공인 전용관</span>
        </div>
        ...
        <p className="text-gray-500 text-sm md:text-base leading-relaxed mb-10">
          소상공인 전용관이 새로운 모습으로 단장하고 있어요. 곧 다시 찾아뵙겠습니다.
        </p>
