    ...
    try {
      ...
      if (!alreadyExpert) {
        ...
        if (expertError) {
          ...
          if (
            expertError.message.includes("duplicate") ||
            expertError.message.includes("violates")
          ) {
            // 중복 에러는 이미 전문가 데이터가 있다고 보고 Agent 등록 흐름을 계속 진행합니다.
          } else {
        ...
        {isAlreadyExpert && step === 2 && (
          <div className="bg-blue-50 border border-blue-200 rounded-xl px-4 py-3 mb-4">
            <p className="text-xs text-blue-600 font-semibold">
              ✅ 이미 전문가로 등록되어 있어요! 새 Agent 정보만 입력하면 돼요.
            </p>
          </div>
        )}
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-5 md:p-6">
              ...
              <div className="flex flex-col gap-4">
                <div className="flex flex-col md:flex-row gap-3">
                  ...
                  <div className="flex-1">
                    <label className="block text-xs font-bold text-gray-700 mb-1.5">
                      직함·자격 <span className="text-orange-500">*</span>
                    </label>
                    <input
                      type="text"
                      placeholder="예: 변호사, 데이터 사이언티스트"
                      value={form.title}
                ...
                <div>
                  ...
                  <input
                    type="text"
                    placeholder="예: 10년 경력의 계약 전문 변호사입니다"
                    maxLength={60}
                    value={form.intro}
                ...
                <div>
                  ...
                  <textarea
                    rows={4}
                    placeholder="전문 분야, 주요 경력, Agent 개발 배경 등을 작성해주세요."
          ...
          <div className="flex flex-col gap-5">
            <div className="bg-white rounded-2xl border border-gray-200 p-5 md:p-6">
              ...
              <div className="flex flex-col gap-4">
                <div>
                  <label className="block text-xs font-bold text-gray-700 mb-1.5">
                    Agent 이름 <span className="text-orange-500">*</span>
                  </label>
                  <input
                    type="text"
                    placeholder="예: 계약서 리뷰 Agent"
                    maxLength={40}
                ...
                <div>
                  <label className="block text-xs font-bold text-gray-700 mb-1.5">
                    한 줄 설명 <span className="text-orange-500">*</span>
                  </label>
                  <input
                    type="text"
                    placeholder="예: 계약서를 업로드하면 위험 조항을 즉시 분석합니다"
                    maxLength={80}
                    value={form.agentDesc}
                    onChange={e => update("agentDesc", e.target.value)}
                    className="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm outline-none focus:border-blue-500 bg-gray-50"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    rows={3}
                    placeholder="Agent가 어떤 문제를 해결하는지 작성해주세요."
                    value={form.agentLongDesc}
                    onChange={e => update("agentLongDesc", e.target.value)}
                    className="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm outline-none focus:border-blue-500 bg-gray-50 resize-none"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    type="text"
                    placeholder="예: 이 계약서의 불리한 조항을 찾아줘"
                    value={form.sampleQuestion}
                    onChange={e => update("sampleQuestion", e.target.value)}
                    className="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm outline-none focus:border-blue-500 bg-gray-50"
                  />
                </div>
              </div>
          ...
          <div className="flex flex-col gap-5">
            <div className="bg-white rounded-2xl border border-gray-200 p-5 md:p-6">
              ...
              <div className="flex flex-col md:flex-row gap-3 mb-4">
                <div className="flex-1">
                  <label className="block text-xs font-bold text-gray-700 mb-1.5">
                    베이직 플랜 (월, 원) <span className="text-orange-500">*</span>
                  </label>
                  <input
                    type="number"
                    placeholder="예: 89000"
                    value={form.basicPrice}
                    onChange={e => update("basicPrice", e.target.value)}
                    className="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm outline-none focus:border-blue-500 bg-gray-50"
                  />
                </div>
                ...
                <div className="flex-1">
                  ...
                  <input
                    ...
                    value={form.proPrice}
                    onChange={e => update("proPrice", e.target.value)}
                    className="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm outline-none focus:border-blue-500 bg-gray-50"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={e => update("trialCount", e.target.value)}
                  className="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm outline-none focus:border-blue-500 bg-gray-50"
                >
